            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/bundle/update/{{ $bundle->id }}" method=post>
                            @csrf
                            <div class="mb-3">
                              <label for="exampleInputEmail1" class="form-label">Nama Bundle</label>
                              <input type="text" id="name" value="{{ $bundle->name }}" name="name" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Bundle" aria-describedby="emailHelp">
                            </div>
                                    ...
                                    @foreach ($product as $service)   
                                      <div class="form-group mt-1 col-md-4 mb-3">
                                        <input class="form-check-input cbservice" 
                                            @if (in_array($service->id, $bundled))
                                                {{ 'checked' }}
                                            @endif
